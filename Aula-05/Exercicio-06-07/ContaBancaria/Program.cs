...
internal class Program
{
    private static void Main(string[] args)
    {
       // Primeira Conta : ContaBancaria (Sem Limite)
        ContaBancaria contaSimples = new ContaBancaria( "Banco do Brasil", 1234,10001,500.00 );
    
        // Segunda Conta : ContaCorrente (Com Limite)
        ContaCorrente contaCorrente = new ContaCorrente("Itaú",2444, 222333, 1500.00,3000.00 );
    ...
    public class ContaBancaria
    {
        ...
        public double SaldoAtual {get; protected set;} // proteje quem herdar tambem
